...
@interface ZJLTabBarController ()<UIScrollViewDelegate>
...
#warning 以后修改launchImage  名字
    ...
    btn.frame               = CGRectMake(SCREEN_WIDTH - 80, 30, 60, 25);
...
- (void)beginAnimation
{
    ...
    animation.accessibilityFrame    = CGRectMake(0, 64, SCREEN_WIDTH, SCREEN_HEIGHT);
...
//    ZJLNavigationController *nav1 = [self setChildVC:homeVC title:@"首页" imageName:@"homeNormal" withSelectedName:@"homeHight"];
//    
...
//    ZJLNavigationController *nav2 =  [self setChildVC:cateVC title:@"分类" imageName:@"categoryNormal" withSelectedName:@"categoryHight"];
//    
//    WTKFoundVC *foundVC         = [[WTKFoundVC alloc]initWithViewModel:[[WTKFoundViewModel alloc]initWithService:nil params:@{@"title":@"发现"}]];
//    ZJLNavigationController *nav3 =   [self setChildVC:foundVC title:@"发现" imageName:@"foundNormal" withSelectedName:@"foundHight"];
//    
...
//    
//    ZJLNavigationController *nav4 =  [self setChildVC:shopVC title:@"购物车" imageName:@"carNormal" withSelectedName:@"carHight"];
//    
//    WTKMeVC *meVC               = [[WTKMeVC alloc]initWithViewModel:[[WTKMeViewModel alloc]initWithService:nil params:@{@"title":@"我的"}]];
//    ZJLNavigationController *nav5 =  [self setChildVC:meVC title:@"我的" imageName:@"meNoraml" withSelectedName:@"meHight"];
//    
//    self.viewControllers = @[nav1,nav2,nav3,nav4,nav5];
}
- (ZJLNavigationController *)setChildVC:(UIViewController *)vc title:(NSString *)title imageName:(NSString *)imgName withSelectedName:(NSString *)selectedName
{
    vc.title                = title;
