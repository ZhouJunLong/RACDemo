                              ...
                              endPoint:(CGPoint)endP
{
    ...
    CGPoint endPoint                = endP.x == 0 && endP.y == 0 ? CGPointMake(SCREEN_WIDTH / 5.0 * 3.0 + SCREEN_WIDTH / 10.0, SCREENHEIGHT - 25) : endP;
...
//    
//    UIWindow *window = [[UIApplication sharedApplication].delegate window];
//    UIView *blurView        = [[UIView alloc]initWithFrame:CGRectMake(0, 0, SCREENWIDTH, kHeight)];
...
//    
//    CGFloat colMargin       = SCREENWIDTH / 2.0 - width;
//    
...
+ (void)dismissShareView:(UITapGestureRecognizer *)gesture
{
    ...
    [UIView animateWithDuration:0.3
                     animations:^{
                         imgView.frame = CGRectMake((SCREENWIDTH - 242) / 2.0, -106 - 30 , 242, 106);
                     }
                     completion:^(BOOL finished) {
    ...
    for (int i = 0 ; i < 6; i++)
    {
        ...
        [UIView animateWithDuration:0.4 - 0.03 * i
                         animations:^{
                             view.frame = CGRectMake(view.frame.origin.x, view.frame.origin.y + SCREENHEIGHT  - view.frame.origin.y, view.frame.size.width, view.frame.size.height);
                         }
                         completion:^(BOOL finished) {
